...
* [模型載入](#模型載入)
* [模型評估](#模型評估)
* [隨機輸出10筆預測之結果和正解](#隨機輸出10筆預測之結果和正解)
* [結語](#結語)
## 目的
#### 本專案希望藉由深度學習中的卷積神經網路(convolutional neural network)對圖像進行花品種的分類。本專案使用CNN而不是使用DNN的目的在於CNN的權重參數比DNN少，使得擬合CNN模型的速度較快且較不易  過擬合，並且能使用較少的訓練集就能訓練出與DNN相同的模型能力，且通常圖像辨識中的目標經常以不同角度、位置、大小等等呈現，CNN的優勢在於它依然可以較正確的識別目標，因此本專案採用CNN作為網路架構來   訓練圖像辨識之模型。
#### 以下是本專案執行的步驟
## 匯入相關函式庫 
...
## 模型評估
#### 我認為此任務也是用recall為主要參考，因為此任務應是需要正確的分類花的種類，那透過recall指標可以清楚了解分類的正確程度。文字部分的評估指標是針對'dandelion'這個類別做的評估，而下方圖片部分的評估指標是使用參數average='macro'，期望輸出不受個類別樣本數的影響。
...
![image](https://user-images.githubusercontent.com/68068287/157708518-614e35fd-67a7-4294-aeb2-86fe19c63576.png)

![image](https://user-images.githubusercontent.com/68068287/157458702-b72bc75e-a41d-4c1a-9f22-997ecaf59437.png)

## 隨機輸出10筆預測之結果和正解
![image](https://user-images.githubusercontent.com/68068287/157710567-53a81982-4881-4fb5-bdad-4f1420c83ee0.png)
![image](https://user-images.githubusercontent.com/68068287/157710323-c6c8fa09-d26d-4384-b454-36e9ee65f077.png)
![image](https://user-images.githubusercontent.com/68068287/157710377-eb5ad7cc-589c-4757-984c-1b3204d1594f.png)
